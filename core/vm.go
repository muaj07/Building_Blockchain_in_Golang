...
import(
	"encoding/binary"
	//"github.com/muaj07/transport/util"
)

type Instruction byte

const (
	InstrPushInt     Instruction = 0x0a //10 in Hexadecimal Push Int value
...
func(vm *VM) Exec(instr Instruction) error{
	...
	case InstrStore:
		...
		switch v := value.(type) { //Switch loop for the value type for the variable "value"
		case int:
